...
public interface IRAGFlowService
{
    ...
    Task<RAGResult> GenerateAnswerAsync(long appId, string conversationId, string question, List<LlmCitationModel> citations);
    Task<RAGResult> GenerateAnswerAsync(string question, List<LlmCitationModel> citations);
