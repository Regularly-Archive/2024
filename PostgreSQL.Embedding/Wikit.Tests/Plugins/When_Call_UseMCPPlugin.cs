...
namespace Wikit.Tests.Plugins
{
    ...
    /// </summary>
    public class When_Call_UseMCPPlugin
    {
        ...
        [Fact]
        public void It_Should_InitializePlugin_Successfully_WithFactory()
        {
            // Arrange & Act
        ...
        [Fact]
        public void It_Should_ReturnConnectionStats_WhenFactoryRegistered()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
        ...
        [Fact]
        public async Task It_Should_ReturnEmptyList_WhenNoServersExist()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
        ...
        [Fact]
        public async Task It_Should_ReturnServerList_WhenServersExist()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenListingToolsForUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenRefreshingToolsForUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenListingResourcesForUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenListingPromptsForUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenCallingToolForUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public async Task It_Should_ReturnError_WhenDisconnectingUnknownServer()
        {
            // Arrange
            var plugin = new UseMCPPlugin(_serviceProvider);
            var kernel = CreateKernelWithContext(appId: 1);
        ...
        [Fact]
        public void It_Should_ThrowException_WhenFactoryNotRegistered()
        {
            // Arrange
